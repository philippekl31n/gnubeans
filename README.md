...
- [`docs/beancount-example.beancount`](docs/beancount-example.beancount) — canonical Beancount sample file (generated by `bean-example`), used as a reference for account structure, commodity names, and output format
- [`docs/Beancount - Language Syntax.md`](docs/Beancount%20-%20Language%20Syntax.md) — Beancount language syntax reference
