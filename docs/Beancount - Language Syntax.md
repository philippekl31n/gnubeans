...
This way you can insert markup to organize your file for various outline modes, such as [org-mode](http://orgmode.org/) in Emacs. For example, you could organize your input file by institution like this and fold & unfold each of the sections independently,:
...
TODO(blais): Enumerate the full list of valid flags here [from the parser](https://github.com/beancount/beancount/blob/master/beancount/parser/lexer.l#L134).
...
### **Padding Cost Basis** {#padding-cost-basis}
